...
namespace pikker
{
    public class ContiesPicker : ContentPage
    {
            ...
            Label lbl;
            Image img;
            string[] img_list = new string[] { "0.png", "1.png", "2.png", "3.png", "4.png", "index5.png", "index6.png", "index_1.png", "index7.png", "index9.png", "index8.png", "index10.png", "index11.png", "index12.png", "index13.png" };
        ...
        private void Picker_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            img.Source = $"{img_list[picker.SelectedIndex]}";
        }
        ...
        private void Picker2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            img.Source = $"{img_list[picker2.SelectedIndex]}";
        }
    }
}